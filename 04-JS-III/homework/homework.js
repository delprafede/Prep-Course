...
function promedioResultadosTest(resultadosTest) {
  ...
  promediototal= promediototal + resultadosTest[i];
}
...
function diaDeLaSemana(numeroDeDia) {
  ...
  // Es fin de semana si el día corresponde a Sábado o Domingo y “Es dia Laboral” en caso contrario. 
  //Escribe tu código aquí   
...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí // .toString:
 var numerotoString = n.toString()
  if (numerotoString[0] == 9) {
    return true;
  }
 return false; // .toString de numero a string..
}
...
function continueStatement(numero) {
  ...
  for ( i = 0; i< 10; i++) {
    if ( i === 5) {
      ...
      continueNumeros.push(suma)
    }
  } 
    return continueNumeros;
